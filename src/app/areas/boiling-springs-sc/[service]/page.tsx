...
const citySlug = 'boiling-springs-sc';
...
export async function generateMetadata({ params }: { params: Promise<{ service: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    description: `Professional ${service.name.toLowerCase()} services in ${city.name}, ${city.county}, SC. Free estimates. Call (864) 760-9203.`,
    keywords,
