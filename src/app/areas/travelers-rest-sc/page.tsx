...
export default function TravelersRestPage() {
  const services = [
    { name: 'Stump Grinding', description: 'Professional stump removal for Travelers Rest properties.', href: '/areas/travelers-rest-sc/stump-grinding' },
    { name: 'Brush Hogging', description: 'Clear overgrown mountain properties and rural land.', href: '/areas/travelers-rest-sc/brush-hogging' },
    { name: 'Land Clearing', description: 'Site preparation for homes in the beautiful TR area.', href: '/areas/travelers-rest-sc/land-clearing' },
  ];
      ...
      <main className="pt-16 lg:pt-[104px]">
        <section className="bg-primary py-16 lg:py-20">
          <div className="max-w-6xl mx-auto px-6">
            <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Service Areas', href: '/#service-areas' }, { label: 'Travelers Rest, SC' }]} />
            ...
            <p className="text-xl text-gray-300 max-w-3xl mb-8">
              Nelson Land & Stump serves Travelers Rest and northern Greenville County with professional land clearing services near the Blue Ridge foothills.
            </p>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-black text-primary mb-10 text-center" style={{ fontFamily: 'var(--font-oswald)' }}>OUR TRAVELERS REST SERVICES</h2>
        ...
        <section className="py-16 bg-primary">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl md:text-4xl font-black text-white mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>NEED LAND CLEARING IN TRAVELERS REST?</h2>
