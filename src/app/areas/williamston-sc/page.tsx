...
export const metadata: Metadata = {
  title: 'Stump Grinding Williamston SC',
  ...
  alternates: {
    canonical: '/areas/williamston-sc',
  },
};
...
const localBusinessSchema = {
  ...
  "@type": "LocalBusiness",
  name: "Nelson Land & Stump Services - Williamston",
  description: "Professional stump grinding, brush hogging, and land clearing services in Williamston, SC and surrounding areas.",
  url: "https://www.nelsonstump.com/areas/williamston-sc",
...
export default function WilliamstonPage() {
  const neighborhoods = [
    'Downtown Williamston', 'West Main', 'Mill Street', 'Pelzer Highway', 'Anderson Road Area', 'Mineral Spring Park',
  ];

  const services = [
    {
      name: 'Stump Grinding',
      description: 'Remove unsightly stumps from your Williamston property. We grind stumps 6-8 inches below ground level.',
      href: '/areas/williamston-sc/stump-grinding',
    },
    {
      name: 'Brush Hogging',
      description: 'Clear overgrown fields, fence lines, and trails on your Anderson County property.',
      href: '/areas/williamston-sc/brush-hogging',
    },
    {
      name: 'Land Clearing',
      description: 'Full lot clearing for new construction or property development in the Williamston area.',
      href: '/areas/williamston-sc/land-clearing',
    },
  ];
  ...
  return (
    <>
      ...
      <main className="pt-16 lg:pt-[104px]">
        ...
        <section className="bg-primary py-16 lg:py-20">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mb-8">
              Nelson Land & Stump is proudly based right here in Williamston, serving our hometown and
              Anderson County with professional stump grinding, brush hogging, and land clearing services.
              As your neighbors, we take special pride in every job we do in our community.
            </p>
        ...
        {/* About Williamston Service */}
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-black text-primary mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
                  YOUR HOMETOWN WILLIAMSTON LAND CLEARING EXPERTS
                </h2>
                <p className="text-muted text-lg mb-4">
                  Williamston is home—it&apos;s where we live, work, and raise our families. As a family-owned
                  business headquartered right here on Lewis Road, we know the community inside and out.
                  From the historic downtown to the neighborhoods around Mineral Spring Park, we&apos;ve been
                  serving our neighbors for years.
                </p>
                <p className="text-muted text-lg mb-4">
                  Whether you need a single stump removed from your backyard, brush hogging on your rural
                  property, or complete land clearing for a new home site, we bring the same dedication
                  to every project—because when you hire us, you&apos;re hiring your neighbors.
                </p>
                <p className="text-muted text-lg">
                  Being based in Williamston means faster response times, lower travel costs, and a personal
                  investment in making sure every job is done right. We&apos;re not just working in your
                  community—we&apos;re part of it.
                </p>
              </div>
              <div className="bg-muted-light rounded-lg p-8">
                <h3 className="font-bold text-primary text-xl mb-4">Why Williamston Chooses Us</h3>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <span className="text-muted"><strong>Hometown Business:</strong> We live here and take pride in our community</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-accent mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span className="text-muted"><strong>Fastest Response:</strong> Same-day estimates often available for local jobs</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-accent mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span className="text-muted"><strong>Competitive Pricing:</strong> No travel fees for Williamston properties</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-accent mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-black text-primary mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              WILLIAMSTON AREAS WE SERVE
            </h2>
            <p className="text-muted text-lg mb-8">
              We provide stump grinding, brush hogging, and land clearing services throughout Williamston and the surrounding areas, including:
            </p>
        ...
        <section className="py-16 bg-muted-light">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <p className="text-muted text-lg mb-8">
              In addition to Williamston, we provide services throughout Anderson County and Upstate South Carolina:
            </p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <Link href="/areas/fountain-inn-sc" className="bg-white p-4 rounded-lg text-center hover:shadow-md transition-shadow">
                <span className="font-bold text-primary">Fountain Inn</span>
              </Link>
        ...
        <section className="py-16 bg-primary">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl md:text-4xl font-black text-white mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              NEED STUMP GRINDING IN WILLIAMSTON?
            </h2>
            <p className="text-gray-300 text-lg mb-8">
              Contact Nelson Land & Stump today for a free, no-obligation quote on stump grinding,
              brush hogging, or land clearing services in Williamston, SC and surrounding areas.
            </p>
