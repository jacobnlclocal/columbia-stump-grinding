...
export const metadata: Metadata = {
  title: 'Stump Grinding Irmo SC | Columbia Stump Grinding',
  description: 'Looking for stump grinding Irmo SC? Professional stump removal services in Irmo, SC. Stump grinding companies near me serving Downtown Irmo, Lake Murray, Harbison, St. Andrews, Dutch Fork. Free estimates. Call (864) 760-9203.',
  keywords: 'stump grinding Irmo SC, stump removal Irmo SC, stump grinding companies near me, professional stump removal, stump grinder services near me, land clearing Irmo, brush hogging Irmo SC, tree stump grinding Irmo',
  alternates: {
    canonical: '/areas/irmo-sc',
  },
};


export default function IrmoPage() {
  const neighborhoods = [
    'Downtown Irmo', 'Lake Murray', 'Harbison', 'St. Andrews', 'Dutch Fork', 'Friarsgate', 'Timberlake', 'Seven Oaks', 'Ballentine',
  ];

  const services = [
    {
      name: 'Stump Grinding',
      description: 'Remove unsightly stumps from your Irmo property. We grind stumps 6-8 inches below ground level.',
      href: '/areas/irmo-sc/stump-grinding',
    },
    {
      name: 'Brush Hogging',
      description: 'Clear overgrown fields, fence lines, and trails on your Lexington County property.',
      href: '/areas/irmo-sc/brush-hogging',
    },
    {
      name: 'Land Clearing',
      description: 'Full lot clearing for new construction or property development in the Irmo area.',
      href: '/areas/irmo-sc/land-clearing',
    },
  ];
      ...
      <main className="pt-16 lg:pt-[104px]">
        ...
        <section className="bg-primary py-16 lg:py-20">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              STUMP GRINDING IRMO SC | PROFESSIONAL STUMP REMOVAL
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mb-8">
              Looking for stump grinding in Irmo SC? Columbia Stump Grinding provides professional stump removal
              services, brush hogging, and land clearing throughout Irmo and Lexington County. As one of the
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-black text-primary mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
                  PROFESSIONAL STUMP REMOVAL SERVICES IN IRMO
                </h2>
                <p className="text-muted text-lg mb-4">
                  Irmo is a thriving community nestled between Columbia and Lake Murray, known for its excellent schools
                  and family-friendly atmosphere. The Dutch Fork area continues to see significant growth, creating
                  constant demand for stump removal and land clearing services. Whether you&apos;re preparing a lot
                  near Harbison or need stump grinding for your lakefront property, Columbia Stump Grinding is here to help.
                </p>
                <p className="text-muted text-lg mb-4">
                  We understand the unique challenges of working in Lexington County—from navigating tight
                  suburban lots in Friarsgate to clearing larger properties near Lake Murray. Our equipment is sized right for any job,
                  and we always leave your property clean and ready for the next step.
                </p>
                <p className="text-muted text-lg">
                  As a local, family-owned business, we take pride in serving our Irmo neighbors with
                  honest pricing, reliable service, and results that speak for themselves.
                </p>
              </div>
              <div className="bg-muted-light rounded-lg p-8">
                <h3 className="font-bold text-primary text-xl mb-4">Why Irmo Chooses Us</h3>
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-muted"><strong>Competitive Pricing:</strong> Fair rates for Irmo area projects</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-accent mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <p className="text-muted text-base mb-8">
              Our Irmo service area covers all neighborhoods from downtown to Lake Murray, including both residential and commercial properties. Whether you have a small backyard stump in Seven Oaks or need extensive land clearing for new development in the Dutch Fork area, our team has the equipment and expertise to handle your project efficiently and professionally.
            </p>
        ...
        <section className="py-16 bg-muted-light">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <p className="text-muted text-lg mb-4">
              In addition to Irmo, we provide services throughout the Midlands South Carolina area:
            </p>
            <p className="text-muted text-base mb-8">
              Our service area covers all of Richland and Lexington Counties. If you are located outside of Irmo proper but still within the Midlands area, we can likely serve you as well. Contact us to confirm service availability for your specific location and to schedule a free on-site estimate.
            </p>
          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Link href="/blog/how-much-does-stump-grinding-cost-columbia-sc" className="bg-muted-light rounded-lg p-6 hover:shadow-lg transition-shadow">
                <h3 className="font-bold text-primary text-lg mb-2">Stump Grinding Costs in Irmo</h3>
                <p className="text-muted text-sm">Complete pricing guide for stump grinding in the Irmo area.</p>
              </Link>
        ...
        <section className="py-16 bg-primary">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl md:text-4xl font-black text-white mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              NEED STUMP GRINDING IN IRMO?
            </h2>
            <p className="text-gray-300 text-lg mb-8">
              Contact Columbia Stump Grinding today for a free, no-obligation quote on stump grinding,
              brush hogging, or land clearing services in Irmo, SC and surrounding areas.
            </p>
