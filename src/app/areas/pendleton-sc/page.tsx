...
export const metadata: Metadata = {
  title: 'Stump Grinding Pendleton SC',
  description: 'Professional stump grinding, brush hogging, and land clearing services in Pendleton, SC. Serving Anderson County. Free estimates. Call (864) 760-9203.',
  keywords: 'stump grinding Pendleton SC, land clearing Pendleton, brush hogging Anderson County, stump removal Pendleton South Carolina',
  alternates: {
    canonical: '/areas/pendleton-sc',
  },
};
...
const localBusinessSchema = {
  ...
  "@type": "LocalBusiness",
  name: "Nelson Land & Stump Services - Pendleton",
  description: "Professional stump grinding, brush hogging, and land clearing services in Pendleton, SC and surrounding areas.",
  url: "https://www.nelsonstump.com/areas/pendleton-sc",
...
export default function PendletonPage() {
  const neighborhoods = [
    'Downtown Pendleton', 'Historic District', 'Clemson Boulevard', 'Cherry Street', 'Pendleton Place', 'Town Square Area',
  ];

  const services = [
    {
      name: 'Stump Grinding',
      description: 'Remove unsightly stumps from your Pendleton property. We grind stumps 6-8 inches below ground level.',
      href: '/areas/pendleton-sc/stump-grinding',
    },
    {
      name: 'Brush Hogging',
      description: 'Clear overgrown fields, fence lines, and trails on your Anderson County property.',
      href: '/areas/pendleton-sc/brush-hogging',
    },
    {
      name: 'Land Clearing',
      description: 'Full lot clearing for new construction or property development in the Pendleton area.',
      href: '/areas/pendleton-sc/land-clearing',
    },
  ];
  ...
  return (
    <>
      ...
      <main className="pt-16 lg:pt-[104px]">
        ...
        <section className="bg-primary py-16 lg:py-20">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              STUMP GRINDING & LAND CLEARING IN PENDLETON, SC
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mb-8">
              Nelson Land & Stump provides professional stump grinding, brush hogging, and land clearing services
              throughout Pendleton and Anderson County. From historic properties to new developments,
        ...
        {/* About Pendleton Service */}
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-black text-primary mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
                  YOUR LOCAL PENDLETON LAND CLEARING EXPERTS
                </h2>
                <p className="text-muted text-lg mb-4">
                  Pendleton is one of the largest historic districts in the nation, featuring beautiful antebellum
                  homes and a charming downtown square. Whether you&apos;re maintaining a historic property in
                  the district or clearing land for new construction near Clemson Boulevard, Nelson Land & Stump
                  is here to help.
                </p>
                <p className="text-muted text-lg mb-4">
                  We understand the unique needs of Pendleton property owners—from carefully working around
                  historic landscapes to clearing larger parcels for development. Our equipment is sized right
                ...
                <p className="text-muted text-lg">
                  ...
                  Anderson County neighbors with honest pricing, reliable service, and results that speak for themselves.
                </p>
              </div>
              <div className="bg-muted-light rounded-lg p-8">
                <h3 className="font-bold text-primary text-xl mb-4">Why Pendleton Chooses Us</h3>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <span className="text-muted"><strong>Local Knowledge:</strong> We know Anderson County&apos;s terrain and soil conditions</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-accent mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-muted"><strong>Competitive Pricing:</strong> Fair rates for Pendleton area projects</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-accent mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-black text-primary mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              PENDLETON AREAS WE SERVE
            </h2>
            <p className="text-muted text-lg mb-8">
              We provide stump grinding, brush hogging, and land clearing services throughout Pendleton and the surrounding areas, including:
            </p>
        ...
        <section className="py-16 bg-muted-light">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <p className="text-muted text-lg mb-8">
              In addition to Pendleton, we provide services throughout Anderson County and Upstate South Carolina:
            </p>
        ...
        <section className="py-16 bg-primary">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl md:text-4xl font-black text-white mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              NEED STUMP GRINDING IN PENDLETON?
            </h2>
            <p className="text-gray-300 text-lg mb-8">
              Contact Nelson Land & Stump today for a free, no-obligation quote on stump grinding,
              brush hogging, or land clearing services in Pendleton, SC and surrounding areas.
            </p>
