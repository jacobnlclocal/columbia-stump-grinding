...
export const metadata: Metadata = {
  title: 'Stump Grinding Walhalla SC',
  description: 'Professional stump grinding, brush hogging, and land clearing services in Walhalla, SC. Serving Oconee County. Free estimates. Call (864) 760-9203.',
  keywords: 'stump grinding Walhalla SC, land clearing Walhalla, brush hogging Oconee County, stump removal Walhalla South Carolina',
  alternates: {
    canonical: '/areas/walhalla-sc',
  },
};
...
const localBusinessSchema = {
  ...
  url: "https://nelsonstump.com/areas/walhalla-sc",
...
export default function WalhallaPage() {
  const neighborhoods = [
    'Downtown Walhalla', 'Main Street', 'College Street', 'Stumphouse', 'Oconee Station', 'Blue Ridge Railroad', 'Mountain Rest',
  ];

  const services = [
    {
      name: 'Stump Grinding',
      description: 'Remove unsightly stumps from your Walhalla property. We grind stumps 6-8 inches below ground level.',
      href: '/areas/walhalla-sc/stump-grinding',
    },
    {
      name: 'Brush Hogging',
      description: 'Clear overgrown mountain properties, fields, and trails throughout Oconee County.',
      href: '/areas/walhalla-sc/brush-hogging',
    },
    {
      name: 'Land Clearing',
      description: 'Full lot clearing for new construction or property development in the Walhalla area.',
      href: '/areas/walhalla-sc/land-clearing',
    },
  ];
  ...
  return (
    <>
      ...
      <main className="pt-16 lg:pt-[104px]">
        ...
        <section className="bg-primary py-16 lg:py-20">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              STUMP GRINDING & LAND CLEARING IN WALHALLA, SC
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mb-8">
              Nelson Land & Stump provides professional stump grinding, brush hogging, and land clearing services
              throughout Walhalla and Oconee County. From historic downtown properties to mountain acreage
              near Stumphouse Tunnel, we&apos;ve got the equipment and experience to handle your project.
            </p>
        ...
        {/* About Walhalla Service */}
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-black text-primary mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
                  YOUR LOCAL WALHALLA LAND CLEARING EXPERTS
                </h2>
                <p className="text-muted text-lg mb-4">
                  Walhalla, the county seat of Oconee County, is known for its rich German heritage and stunning
                  Blue Ridge Mountain scenery. Whether you&apos;re clearing land for a cabin near Mountain Rest or
                  removing stumps from a historic property on Main Street, Nelson Land & Stump is ready to help.
                </p>
                <p className="text-muted text-lg mb-4">
                  We understand the unique challenges of working in the mountain foothills—from rocky soil conditions
                  to steep terrain near Stumphouse Tunnel and Oconee Station. Our equipment is built to handle
                  the demanding conditions common to Oconee County properties.
                </p>
                <p className="text-muted text-lg">
                  As a local, family-owned business based in Williamston, we take pride in serving the Upstate
                  with honest pricing, reliable service, and results that speak for themselves.
                </p>
              </div>
              <div className="bg-muted-light rounded-lg p-8">
                <h3 className="font-bold text-primary text-xl mb-4">Why Walhalla Chooses Us</h3>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <span className="text-muted"><strong>Mountain Expertise:</strong> We handle rocky terrain and steep grades</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-accent mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-muted"><strong>Competitive Pricing:</strong> Fair rates for Walhalla area projects</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-accent mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-black text-primary mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              WALHALLA AREAS WE SERVE
            </h2>
            <p className="text-muted text-lg mb-8">
              We provide stump grinding, brush hogging, and land clearing services throughout Walhalla and the surrounding areas, including:
            </p>
        ...
        <section className="py-16 bg-muted-light">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <p className="text-muted text-lg mb-8">
              In addition to Walhalla, we provide services throughout Oconee County and Upstate South Carolina:
            </p>
        ...
        <section className="py-16 bg-primary">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl md:text-4xl font-black text-white mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              NEED STUMP GRINDING IN WALHALLA?
            </h2>
            <p className="text-gray-300 text-lg mb-8">
              Contact Nelson Land & Stump today for a free, no-obligation quote on stump grinding,
              brush hogging, or land clearing services in Walhalla, SC and surrounding areas.
            </p>
