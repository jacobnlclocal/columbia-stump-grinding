...
export const metadata: Metadata = {
  title: 'Stump Grinding & Land Clearing in Walhalla SC | Nelson Land & Stump',
...
export default function WalhallaPage() {
  const services = [
    { name: 'Stump Grinding', description: 'Professional stump removal for Walhalla properties.', href: '/areas/walhalla-sc/stump-grinding' },
    { name: 'Brush Hogging', description: 'Clear overgrown mountain properties and rural land.', href: '/areas/walhalla-sc/brush-hogging' },
    { name: 'Land Clearing', description: 'Site preparation in the Blue Ridge foothills.', href: '/areas/walhalla-sc/land-clearing' },
  ];
      ...
      <main className="pt-16 lg:pt-[104px]">
        <section className="bg-primary py-16 lg:py-20">
          <div className="max-w-6xl mx-auto px-6">
            <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Service Areas', href: '/#service-areas' }, { label: 'Walhalla, SC' }]} />
            ...
            <p className="text-xl text-gray-300 max-w-3xl mb-8">
              Nelson Land & Stump serves Walhalla and Oconee County with professional stump grinding, brush hogging, and land clearing services.
            </p>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-black text-primary mb-10 text-center" style={{ fontFamily: 'var(--font-oswald)' }}>OUR WALHALLA SERVICES</h2>
        ...
        <section className="py-16 bg-primary">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl md:text-4xl font-black text-white mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>NEED LAND CLEARING IN WALHALLA?</h2>
