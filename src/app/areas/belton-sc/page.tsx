...
export const metadata: Metadata = {
  title: 'Stump Grinding & Land Clearing in Belton SC | Nelson Land & Stump',
      ...
      <main className="pt-16 lg:pt-[104px]">
        <section className="bg-primary py-16 lg:py-20">
          <div className="max-w-6xl mx-auto px-6">
            <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Service Areas', href: '/#service-areas' }, { label: 'Belton, SC' }]} />
            ...
            <p className="text-xl text-gray-300 max-w-3xl mb-8">
              Nelson Land & Stump serves Belton and surrounding Anderson County with professional stump grinding, brush hogging, and land clearing services.
            </p>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-black text-primary mb-10 text-center" style={{ fontFamily: 'var(--font-oswald)' }}>OUR BELTON SERVICES</h2>
        ...
        <section className="py-16 bg-primary">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl md:text-4xl font-black text-white mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>NEED LAND CLEARING IN BELTON?</h2>
