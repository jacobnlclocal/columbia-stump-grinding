...
export const metadata: Metadata = {
  title: 'Stump Grinding Belton SC',
  description: 'Professional stump grinding, brush hogging, and land clearing services in Belton, SC. Serving Anderson County. Free estimates. Call (864) 760-9203.',
  keywords: 'stump grinding Belton SC, land clearing Belton, brush hogging Anderson County, stump removal Belton South Carolina',
  alternates: {
    canonical: '/areas/belton-sc',
  },
};
...
export default function BeltonPage() {
  const neighborhoods = [
    'Downtown Belton', 'Anderson Highway', 'Brown Avenue', 'Belton City Park Area', 'Calhoun Road', 'Honea Path Highway',
  ];

  const services = [
    {
      name: 'Stump Grinding',
      description: 'Remove unsightly stumps from your Belton property. We grind stumps 6-8 inches below ground level.',
      href: '/areas/belton-sc/stump-grinding',
    },
    {
      name: 'Brush Hogging',
      description: 'Clear overgrown fields, fence lines, and trails on your Anderson County property.',
      href: '/areas/belton-sc/brush-hogging',
    },
    {
      name: 'Land Clearing',
      description: 'Full lot clearing for new construction or property development in the Belton area.',
      href: '/areas/belton-sc/land-clearing',
    },
  ];
  ...
  return (
    <>
      ...
      <main className="pt-16 lg:pt-[104px]">
        ...
        <section className="bg-primary py-16 lg:py-20">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              STUMP GRINDING & LAND CLEARING IN BELTON, SC
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mb-8">
              Nelson Land & Stump provides professional stump grinding, brush hogging, and land clearing services
              throughout Belton and Anderson County. From residential properties to rural acreage,
        ...
        {/* About Belton Service */}
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-black text-primary mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
                  YOUR LOCAL BELTON LAND CLEARING EXPERTS
                </h2>
                <p className="text-muted text-lg mb-4">
                  Belton is a charming small town in Anderson County with a mix of historic properties and newer
                  developments. Whether you&apos;re clearing land for a new home near the city park or removing
                  stumps from an established property on Anderson Highway, Nelson Land & Stump is here to help.
                </p>
                <p className="text-muted text-lg mb-4">
                  We understand the unique needs of Belton property owners—from navigating residential lots
                  to clearing larger rural properties. Our equipment is sized right for any job, and we always
                  leave your property clean and ready for the next step.
                </p>
              ...
              <div className="bg-muted-light rounded-lg p-8">
                <h3 className="font-bold text-primary text-xl mb-4">Why Belton Chooses Us</h3>
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-muted"><strong>Competitive Pricing:</strong> Fair rates for Belton area projects</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-accent mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-black text-primary mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              BELTON AREAS WE SERVE
            </h2>
            <p className="text-muted text-lg mb-8">
              We provide stump grinding, brush hogging, and land clearing services throughout Belton and the surrounding areas, including:
            </p>
        ...
        <section className="py-16 bg-muted-light">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <p className="text-muted text-lg mb-8">
              In addition to Belton, we provide services throughout Anderson County and Upstate South Carolina:
            </p>
        ...
        <section className="py-16 bg-primary">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl md:text-4xl font-black text-white mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              NEED STUMP GRINDING IN BELTON?
            </h2>
            <p className="text-gray-300 text-lg mb-8">
              Contact Nelson Land & Stump today for a free, no-obligation quote on stump grinding,
              brush hogging, or land clearing services in Belton, SC and surrounding areas.
            </p>
