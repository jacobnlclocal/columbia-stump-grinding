...
export const metadata: Metadata = {
  title: 'Stump Grinding Central SC',
...
const localBusinessSchema = {
  ...
  "@type": "LocalBusiness",
  name: "Nelson Land & Stump Services - Central",
  description: "Professional stump grinding, brush hogging, and land clearing services in Central, SC and surrounding areas.",
  url: "https://www.nelsonstump.com/areas/central-sc",
...
export default function CentralPage() {
  const neighborhoods = [
    'Downtown Central', 'Church Street', 'Main Street', 'Southern Wesleyan Area', 'Clemson Boulevard', 'Six Mile',
  ];

  const services = [
    {
      name: 'Stump Grinding',
      description: 'Remove unsightly stumps from your Central property. We grind stumps 6-8 inches below ground level.',
      href: '/areas/central-sc/stump-grinding',
    },
    {
      name: 'Brush Hogging',
      description: 'Clear overgrown fields, fence lines, and trails on your Pickens County property.',
      href: '/areas/central-sc/brush-hogging',
    },
    {
      name: 'Land Clearing',
      description: 'Full lot clearing for new construction or property development in the Central area.',
      href: '/areas/central-sc/land-clearing',
    },
  ];
    ...
    <>
      ...
      <main className="pt-16 lg:pt-[104px]">
        ...
        <section className="bg-primary py-16 lg:py-20">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              STUMP GRINDING & LAND CLEARING IN CENTRAL, SC
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mb-8">
              Nelson Land & Stump provides professional stump grinding, brush hogging, and land clearing services
              throughout Central and Pickens County. From residential properties near Southern Wesleyan University
              to rural acreage toward Six Mile, we&apos;ve got the equipment and experience to handle your project.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-black text-primary mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
                  YOUR LOCAL CENTRAL LAND CLEARING EXPERTS
                </h2>
                <p className="text-muted text-lg mb-4">
                  Central is a vibrant college town in Pickens County, home to Southern Wesleyan University and
                  conveniently located near Clemson. Whether you&apos;re preparing a lot for new construction
                  along Clemson Boulevard or removing stumps from a residential property near Church Street,
                  Nelson Land & Stump delivers professional results.
                </p>
                <p className="text-muted text-lg mb-4">
                  We understand the needs of Central property owners, from managing wooded lots to clearing
                  overgrown fence lines on larger parcels. Our equipment handles everything from single stump
                  removal to multi-acre land clearing projects.
                </p>
                <p className="text-muted text-lg">
                  As a local, family-owned business based in nearby Williamston, we take pride in serving
                  our Pickens County neighbors with honest pricing, reliable service, and results that speak for themselves.
                </p>
              </div>
              <div className="bg-muted-light rounded-lg p-8">
                <h3 className="font-bold text-primary text-xl mb-4">Why Central Chooses Us</h3>
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-muted"><strong>Competitive Pricing:</strong> Fair rates for Central area projects</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-accent mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-black text-primary mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              CENTRAL AREAS WE SERVE
            </h2>
            <p className="text-muted text-lg mb-8">
              We provide stump grinding, brush hogging, and land clearing services throughout Central and the surrounding areas, including:
            </p>
        ...
        <section className="py-16 bg-muted-light">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <p className="text-muted text-lg mb-8">
              In addition to Central, we provide services throughout Pickens County and Upstate South Carolina:
            </p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <Link href="/areas/pendleton-sc" className="bg-white p-4 rounded-lg text-center hover:shadow-md transition-shadow">
                <span className="font-bold text-primary">Pendleton</span>
              </Link>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-primary">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl md:text-4xl font-black text-white mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              NEED STUMP GRINDING IN CENTRAL?
            </h2>
            <p className="text-gray-300 text-lg mb-8">
              Contact Nelson Land & Stump today for a free, no-obligation quote on stump grinding,
              brush hogging, or land clearing services in Central, SC and surrounding areas.
            </p>
