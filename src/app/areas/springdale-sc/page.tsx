...
export const metadata: Metadata = {
  title: 'Stump Grinding Springdale SC | Columbia Stump Grinding',
  description: 'Looking for stump grinding Springdale SC? Professional stump removal services in Springdale, SC. Stump grinding companies near me serving Downtown Springdale, Platt Springs Road, Mineral Springs. Free estimates. Call (864) 760-9203.',
  keywords: 'stump grinding Springdale SC, stump removal Springdale SC, stump grinding companies near me, professional stump removal, stump grinder services near me, land clearing Springdale, brush hogging Springdale SC, tree stump grinding Springdale',
  alternates: {
    canonical: '/areas/springdale-sc',
  },
};
...
export default function SpringdalePage() {
  const neighborhoods = [
    'Downtown Springdale', 'Platt Springs Road', 'Mineral Springs', 'Congaree',
  ];

  const services = [
    {
      name: 'Stump Grinding',
      description: 'Remove unsightly stumps from your Springdale property. We grind stumps 6-8 inches below ground level.',
      href: '/areas/springdale-sc/stump-grinding',
    },
    {
      name: 'Brush Hogging',
      description: 'Clear overgrown fields, fence lines, and trails on your Lexington County property.',
      href: '/areas/springdale-sc/brush-hogging',
    },
    {
      name: 'Land Clearing',
      description: 'Full lot clearing for new construction or property development in the Springdale area.',
      href: '/areas/springdale-sc/land-clearing',
    },
  ];
  ...
  return (
    <>
      ...
      <main className="pt-16 lg:pt-[104px]">
        ...
        <section className="bg-primary py-16 lg:py-20">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              STUMP GRINDING SPRINGDALE SC | PROFESSIONAL STUMP REMOVAL
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mb-8">
              Looking for stump grinding in Springdale SC? Columbia Stump Grinding provides professional stump removal
              services, brush hogging, and land clearing throughout Springdale and Lexington County. As one of the
        ...
        {/* About Springdale Service */}
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-black text-primary mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
                  PROFESSIONAL STUMP REMOVAL SERVICES IN SPRINGDALE
                </h2>
                <p className="text-muted text-lg mb-4">
                  Springdale is a small but growing community in Lexington County, conveniently located between
                  West Columbia and Cayce. With a mix of established neighborhoods and new development, there&apos;s
                  consistent demand for quality stump removal services. Whether you&apos;re preparing a lot for new construction
                ...
                <p className="text-muted text-lg mb-4">
                  ...
                  suburban lots to clearing larger properties. Our equipment is sized right for any job,
                  and we always leave your property clean and ready for the next step.
                </p>
                <p className="text-muted text-lg">
                  As a local, family-owned business, we take pride in serving our Springdale neighbors with
                  honest pricing, reliable service, and results that speak for themselves.
                </p>
              </div>
              <div className="bg-muted-light rounded-lg p-8">
                <h3 className="font-bold text-primary text-xl mb-4">Why Springdale Chooses Us</h3>
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-muted"><strong>Competitive Pricing:</strong> Fair rates for Springdale area projects</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-accent mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-black text-primary mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              SPRINGDALE AREAS WE SERVE
            </h2>
            <p className="text-muted text-lg mb-4">
              We provide stump grinding, brush hogging, and land clearing services throughout Lexington County, including:
            </p>
            <p className="text-muted text-base mb-8">
              Our Springdale service area covers all neighborhoods, including both residential and commercial properties. Whether you have a small backyard stump or need extensive land clearing for new development, our team has the equipment and expertise to handle your project efficiently and professionally.
            </p>
        ...
        <section className="py-16 bg-muted-light">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <p className="text-muted text-lg mb-4">
              In addition to Springdale, we provide services throughout the Midlands South Carolina area:
            </p>
            <p className="text-muted text-base mb-8">
              Our service area covers all of Richland and Lexington Counties. If you are located outside of Springdale proper but still within the Midlands area, we can likely serve you as well. Contact us to confirm service availability for your specific location and to schedule a free on-site estimate.
            </p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-black text-primary mb-8 text-center" style={{ fontFamily: 'var(--font-oswald)' }}>
              SPRINGDALE STUMP GRINDING RESOURCES
            </h2>
            <div className="grid md:grid-cols-3 gap-6">
              <Link href="/blog/how-much-does-stump-grinding-cost-columbia-sc" className="bg-muted-light rounded-lg p-6 hover:shadow-lg transition-shadow">
                <h3 className="font-bold text-primary text-lg mb-2">Stump Grinding Costs in Springdale</h3>
                <p className="text-muted text-sm">Complete pricing guide for stump grinding in the Springdale area.</p>
              </Link>
        ...
        <section className="py-16 bg-primary">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl md:text-4xl font-black text-white mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              NEED STUMP GRINDING IN SPRINGDALE?
            </h2>
            <p className="text-gray-300 text-lg mb-8">
              Contact Columbia Stump Grinding today for a free, no-obligation quote on stump grinding,
              brush hogging, or land clearing services in Springdale, SC and surrounding areas.
            </p>
