...
export const metadata: Metadata = {
  title: 'Stump Grinding Fair Play SC',
...
const localBusinessSchema = {
  ...
  "@type": "LocalBusiness",
  name: "Nelson Land & Stump Services - Fair Play",
  description: "Professional stump grinding, brush hogging, and land clearing services in Fair Play, SC and surrounding areas.",
  url: "https://www.nelsonstump.com/areas/fair-play-sc",
...
export default function FairPlayPage() {
  const neighborhoods = [
    'Downtown Fair Play', 'Lake Hartwell', 'Tugaloo', 'South Union', 'Townville', 'Portman Shoals',
  ];

  const services = [
    {
      name: 'Stump Grinding',
      description: 'Remove unsightly stumps from your Fair Play property. We grind stumps 6-8 inches below ground level.',
      href: '/areas/fair-play-sc/stump-grinding',
    },
    {
      name: 'Brush Hogging',
      description: 'Clear overgrown fields, fence lines, and lakefront property in Oconee County.',
      href: '/areas/fair-play-sc/brush-hogging',
    },
    {
      name: 'Land Clearing',
      description: 'Full lot clearing for new construction or property development near Lake Hartwell.',
      href: '/areas/fair-play-sc/land-clearing',
    },
  ];
  ...
  return (
    <>
      ...
      <main className="pt-16 lg:pt-[104px]">
        ...
        <section className="bg-primary py-16 lg:py-20">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              STUMP GRINDING & LAND CLEARING IN FAIR PLAY, SC
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mb-8">
              Nelson Land & Stump provides professional stump grinding, brush hogging, and land clearing services
              throughout Fair Play and Oconee County. From lakefront properties along Lake Hartwell to rural
              acreage near Townville, we&apos;ve got the equipment and experience to handle your project.
            </p>
        ...
        {/* About Fair Play Service */}
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-black text-primary mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
                  YOUR LOCAL FAIR PLAY LAND CLEARING EXPERTS
                </h2>
                <p className="text-muted text-lg mb-4">
                  Fair Play is a scenic community in Oconee County, nestled along the shores of Lake Hartwell.
                  Whether you&apos;re clearing land for a new lakefront cabin, removing stumps to improve your
                  waterfront view, or maintaining rural acreage near Portman Shoals, Nelson Land & Stump
                  delivers professional results.
                </p>
                <p className="text-muted text-lg mb-4">
                  We understand the unique challenges of lakefront and rural properties in the Fair Play area.
                  Our equipment is designed to navigate sloped terrain and wooded lots while minimizing impact
                  on surrounding vegetation and shoreline areas.
                </p>
                <p className="text-muted text-lg">
                  As a local, family-owned business based in nearby Williamston, we take pride in serving
                  our Oconee County neighbors with honest pricing, reliable service, and results that speak for themselves.
                </p>
              </div>
              <div className="bg-muted-light rounded-lg p-8">
                <h3 className="font-bold text-primary text-xl mb-4">Why Fair Play Chooses Us</h3>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <span className="text-muted"><strong>Lakefront Experience:</strong> We specialize in waterfront property clearing</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-accent mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-muted"><strong>Competitive Pricing:</strong> Fair rates for Fair Play area projects</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-accent mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-black text-primary mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              FAIR PLAY AREAS WE SERVE
            </h2>
            <p className="text-muted text-lg mb-8">
              We provide stump grinding, brush hogging, and land clearing services throughout Fair Play and the surrounding areas, including:
            </p>
        ...
        <section className="py-16 bg-muted-light">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <p className="text-muted text-lg mb-8">
              In addition to Fair Play, we provide services throughout Oconee County and Upstate South Carolina:
            </p>
        ...
        <section className="py-16 bg-primary">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl md:text-4xl font-black text-white mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              NEED STUMP GRINDING IN FAIR PLAY?
            </h2>
            <p className="text-gray-300 text-lg mb-8">
              Contact Nelson Land & Stump today for a free, no-obligation quote on stump grinding,
              brush hogging, or land clearing services in Fair Play, SC and surrounding areas.
            </p>
