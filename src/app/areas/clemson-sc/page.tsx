  ...
  return (
    <>
      ...
      <main className="pt-16 lg:pt-[104px]">
        ...
        <section className="bg-primary py-16 lg:py-20">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              STUMP GRINDING & LAND CLEARING IN CLEMSON, SC
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mb-8">
              Nelson Land & Stump serves Clemson, Seneca, and the surrounding Oconee County area with
              professional stump grinding, brush hogging, and land clearing services. From college town
              properties to lakeside retreats, we handle it all.
            </p>
        ...
        {/* About Clemson Service */}
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-black text-primary mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
                  SERVING THE CLEMSON & LAKE KEOWEE AREA
                </h2>
                <p className="text-muted text-lg mb-4">
                  The Clemson and Seneca area has seen tremendous growth in recent years, especially
                  around Lake Keowee and Lake Hartwell. With new homes going up and people moving to
                  enjoy the lakeside lifestyle, there&apos;s high demand for quality land clearing services.
                </p>
                <p className="text-muted text-lg mb-4">
                  We work with homeowners preparing lots for new construction, property managers
                  maintaining rental properties near Clemson University, and lakefront owners clearing
                  views and creating usable outdoor space.
                </p>
                <p className="text-muted text-lg">
                  Whether you need a single stump ground down in your Clemson backyard or acres cleared
                  for a new Lake Keowee home, we bring the same level of professionalism and attention
                  to detail to every job.
                </p>
              </div>
              <div className="bg-muted-light rounded-lg p-8">
                <h3 className="font-bold text-primary text-xl mb-4">Clemson Area Specialties</h3>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <span className="text-muted"><strong>Lakefront Clearing:</strong> Create views and usable space on waterfront property</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-accent mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span className="text-muted"><strong>Rental Property Service:</strong> Fast turnaround for property managers</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-accent mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span className="text-muted"><strong>New Construction:</strong> Lot clearing for builders and developers</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-accent mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span className="text-muted"><strong>Storm Cleanup:</strong> Quick response after severe weather</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-black text-primary mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              CLEMSON & OCONEE COUNTY AREAS WE SERVE
            </h2>
            <p className="text-muted text-lg mb-8">
              We provide stump grinding, brush hogging, and land clearing services throughout the Clemson and Oconee County area:
            </p>
        ...
        <section className="py-16 bg-primary">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl md:text-4xl font-black text-white mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              NEED STUMP GRINDING IN CLEMSON OR SENECA?
            </h2>
            <p className="text-gray-300 text-lg mb-8">
              Contact Nelson Land & Stump today for a free quote on stump grinding,
              brush hogging, or land clearing services in Clemson, Seneca, and Oconee County.
            </p>
