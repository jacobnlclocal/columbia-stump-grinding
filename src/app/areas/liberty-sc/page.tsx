...
export const metadata: Metadata = {
  title: 'Stump Grinding Liberty SC',
  description: 'Professional stump grinding, brush hogging, and land clearing services in Liberty, SC. Serving Pickens County. Free estimates. Call (864) 760-9203.',
  keywords: 'stump grinding Liberty SC, land clearing Liberty, brush hogging Pickens County, stump removal Liberty South Carolina',
  alternates: {
    canonical: '/areas/liberty-sc',
  },
};
...
const localBusinessSchema = {
  ...
  "@type": "LocalBusiness",
  name: "Nelson Land & Stump Services - Liberty",
  description: "Professional stump grinding, brush hogging, and land clearing services in Liberty, SC and surrounding areas.",
  url: "https://www.nelsonstump.com/areas/liberty-sc",
...
export default function LibertyPage() {
  const neighborhoods = [
    'Downtown Liberty', 'Main Street', 'Depot Street', 'East Main', 'West Main', 'Stewart Gin Road',
  ];

  const services = [
    {
      name: 'Stump Grinding',
      description: 'Remove unsightly stumps from your Liberty property. We grind stumps 6-8 inches below ground level.',
      href: '/areas/liberty-sc/stump-grinding',
    },
    {
      name: 'Brush Hogging',
      description: 'Clear overgrown fields, fence lines, and trails on your Pickens County property.',
      href: '/areas/liberty-sc/brush-hogging',
    },
    {
      name: 'Land Clearing',
      description: 'Full lot clearing for new construction or property development in the Liberty area.',
      href: '/areas/liberty-sc/land-clearing',
    },
  ];
  ...
  return (
    <>
      ...
      <main className="pt-16 lg:pt-[104px]">
        ...
        <section className="bg-primary py-16 lg:py-20">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              STUMP GRINDING & LAND CLEARING IN LIBERTY, SC
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mb-8">
              Nelson Land & Stump provides professional stump grinding, brush hogging, and land clearing services
              throughout Liberty and Pickens County. From residential properties to rural acreage,
        ...
        {/* About Liberty Service */}
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-black text-primary mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
                  YOUR LOCAL LIBERTY LAND CLEARING EXPERTS
                </h2>
                <p className="text-muted text-lg mb-4">
                  Liberty is a welcoming small town in Pickens County known for its friendly community and mix of
                  residential neighborhoods and rural properties. Whether you&apos;re clearing land for a new home
                  near Main Street or removing stumps from a property on Stewart Gin Road, Nelson Land & Stump is here to help.
                </p>
                <p className="text-muted text-lg mb-4">
                  We understand the unique needs of Liberty property owners—from maintaining residential lots in
                  town to clearing larger rural acreage in the surrounding countryside. Our equipment is sized
                  right for any job, and we always leave your property clean and ready for the next step.
                </p>
                <p className="text-muted text-lg">
                  As a local, family-owned business based in nearby Williamston, we take pride in serving our
                  Pickens County neighbors with honest pricing, reliable service, and results that speak for themselves.
                </p>
              </div>
              <div className="bg-muted-light rounded-lg p-8">
                <h3 className="font-bold text-primary text-xl mb-4">Why Liberty Chooses Us</h3>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <span className="text-muted"><strong>Local Knowledge:</strong> We know Pickens County&apos;s terrain and soil conditions</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-accent mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-muted"><strong>Competitive Pricing:</strong> Fair rates for Liberty area projects</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-accent mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-black text-primary mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              LIBERTY AREAS WE SERVE
            </h2>
            <p className="text-muted text-lg mb-8">
              We provide stump grinding, brush hogging, and land clearing services throughout Liberty and the surrounding areas, including:
            </p>
        ...
        <section className="py-16 bg-muted-light">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <p className="text-muted text-lg mb-8">
              In addition to Liberty, we provide services throughout Pickens County and Upstate South Carolina:
            </p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <Link href="/areas/central-sc" className="bg-white p-4 rounded-lg text-center hover:shadow-md transition-shadow">
                <span className="font-bold text-primary">Central</span>
              </Link>
              <Link href="/areas/norris-sc" className="bg-white p-4 rounded-lg text-center hover:shadow-md transition-shadow">
                <span className="font-bold text-primary">Norris</span>
              </Link>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-primary">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl md:text-4xl font-black text-white mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              NEED STUMP GRINDING IN LIBERTY?
            </h2>
            <p className="text-gray-300 text-lg mb-8">
              Contact Nelson Land & Stump today for a free, no-obligation quote on stump grinding,
              brush hogging, or land clearing services in Liberty, SC and surrounding areas.
            </p>
