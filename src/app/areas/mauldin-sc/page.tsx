...
export const metadata: Metadata = {
  title: 'Stump Grinding Mauldin SC',
  description: 'Professional stump grinding, brush hogging, and land clearing services in Mauldin, SC. Serving Greenville County. Free estimates. Call (864) 760-9203.',
  keywords: 'stump grinding Mauldin SC, land clearing Mauldin, brush hogging Greenville County, stump removal Mauldin South Carolina',
  alternates: {
    canonical: '/areas/mauldin-sc',
  },
};
...
export default function MauldinPage() {
  const neighborhoods = [
    'Downtown Mauldin', 'Bridgeway Station', 'Butler Road', 'Planters Row', 'Montclaire', 'Crescentwood Village', 'Holly Springs', 'Brookside', 'Eastdale', 'Greenbrier',
  ];

  const services = [
    {
      name: 'Stump Grinding',
      description: 'Remove unsightly stumps from your Mauldin property. We grind stumps 6-8 inches below ground level.',
      href: '/areas/mauldin-sc/stump-grinding',
    },
    {
      name: 'Brush Hogging',
      description: 'Clear overgrown fields, fence lines, and trails on your Greenville County property.',
      href: '/areas/mauldin-sc/brush-hogging',
    },
    {
      name: 'Land Clearing',
      description: 'Full lot clearing for new construction or property development in the Mauldin area.',
      href: '/areas/mauldin-sc/land-clearing',
    },
  ];
  ...
  return (
    <>
      ...
      <main className="pt-16 lg:pt-[104px]">
        ...
        <section className="bg-primary py-16 lg:py-20">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              STUMP GRINDING & LAND CLEARING IN MAULDIN, SC
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mb-8">
              Nelson Land & Stump provides professional stump grinding, brush hogging, and land clearing services
              throughout Mauldin and Greenville County. From residential properties to commercial lots,
        ...
        {/* About Mauldin Service */}
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-black text-primary mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
                  YOUR LOCAL MAULDIN LAND CLEARING EXPERTS
                </h2>
                <p className="text-muted text-lg mb-4">
                  Mauldin is one of the fastest-growing cities in the Golden Strip, with thriving neighborhoods
                  and new developments throughout. Whether you&apos;re clearing land for a new home near
                  Bridgeway Station or removing stumps from an established property in Planters Row,
                  Nelson Land & Stump is here to help.
                </p>
                <p className="text-muted text-lg mb-4">
                  We understand the unique needs of Mauldin property owners—from maintaining manicured
                  suburban lots to preparing land for new construction. Our equipment is sized right for
                  any job, and we always leave your property clean and ready for the next step.
                </p>
                <p className="text-muted text-lg">
                  As a local, family-owned business based in nearby Williamston, we take pride in serving our
                  Greenville County neighbors with honest pricing, reliable service, and results that speak for themselves.
                </p>
              </div>
              <div className="bg-muted-light rounded-lg p-8">
                <h3 className="font-bold text-primary text-xl mb-4">Why Mauldin Chooses Us</h3>
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-muted"><strong>Competitive Pricing:</strong> Fair rates for Mauldin area projects</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-accent mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-black text-primary mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              MAULDIN AREAS WE SERVE
            </h2>
            <p className="text-muted text-lg mb-8">
              We provide stump grinding, brush hogging, and land clearing services throughout Mauldin and the surrounding areas, including:
            </p>
        ...
        <section className="py-16 bg-muted-light">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <p className="text-muted text-lg mb-8">
              In addition to Mauldin, we provide services throughout Greenville County and Upstate South Carolina:
            </p>
        ...
        <section className="py-16 bg-primary">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl md:text-4xl font-black text-white mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              NEED STUMP GRINDING IN MAULDIN?
            </h2>
            <p className="text-gray-300 text-lg mb-8">
              Contact Nelson Land & Stump today for a free, no-obligation quote on stump grinding,
              brush hogging, or land clearing services in Mauldin, SC and surrounding areas.
            </p>
