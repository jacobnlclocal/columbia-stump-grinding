...
export const metadata: Metadata = {
  title: 'Stump Grinding & Land Clearing in Westminster SC | Nelson Land & Stump',
  ...
  keywords: 'stump grinding Westminster SC, land clearing Westminster, brush hogging Lake Hartwell, stump removal Westminster South Carolina',
};

export default function WestminsterPage() {
  const services = [
    { name: 'Stump Grinding', description: 'Professional stump removal for Westminster properties.', href: '/areas/westminster-sc/stump-grinding' },
    { name: 'Brush Hogging', description: 'Clear overgrown lakefront and rural land.', href: '/areas/westminster-sc/brush-hogging' },
    { name: 'Land Clearing', description: 'Site preparation near Lake Hartwell.', href: '/areas/westminster-sc/land-clearing' },
  ];
      ...
      <main className="pt-16 lg:pt-[104px]">
        <section className="bg-primary py-16 lg:py-20">
          <div className="max-w-6xl mx-auto px-6">
            <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Service Areas', href: '/#service-areas' }, { label: 'Westminster, SC' }]} />
            ...
            <p className="text-xl text-gray-300 max-w-3xl mb-8">
              Nelson Land & Stump serves Westminster and the Lake Hartwell area with professional stump grinding, brush hogging, and land clearing services.
            </p>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-black text-primary mb-10 text-center" style={{ fontFamily: 'var(--font-oswald)' }}>OUR WESTMINSTER SERVICES</h2>
        ...
        <section className="py-16 bg-primary">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl md:text-4xl font-black text-white mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>NEED LAND CLEARING IN WESTMINSTER?</h2>
