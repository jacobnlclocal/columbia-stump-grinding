...
export const metadata: Metadata = {
  title: 'Stump Grinding Westminster SC',
  description: 'Professional stump grinding, brush hogging, and land clearing services in Westminster, SC. Serving Oconee County near Lake Hartwell. Free estimates. Call (864) 760-9203.',
  keywords: 'stump grinding Westminster SC, land clearing Westminster, brush hogging Oconee County, stump removal Westminster South Carolina',
  alternates: {
    canonical: '/areas/westminster-sc',
  },
};
...
const localBusinessSchema = {
  ...
  "@type": "LocalBusiness",
  name: "Nelson Land & Stump Services - Westminster",
  description: "Professional stump grinding, brush hogging, and land clearing services in Westminster, SC and surrounding areas.",
  url: "https://www.nelsonstump.com/areas/westminster-sc",
...
export default function WestminsterPage() {
  const neighborhoods = [
    'Downtown Westminster', 'East Main', 'West Main', 'Long Creek', 'Oakway', 'Chau Ram Falls Area',
  ];

  const services = [
    {
      name: 'Stump Grinding',
      description: 'Remove unsightly stumps from your Westminster property. We grind stumps 6-8 inches below ground level.',
      href: '/areas/westminster-sc/stump-grinding',
    },
    {
      name: 'Brush Hogging',
      description: 'Clear overgrown lakefront properties, rural land, and trails throughout Oconee County.',
      href: '/areas/westminster-sc/brush-hogging',
    },
    {
      name: 'Land Clearing',
      description: 'Full lot clearing for new construction or property development in the Westminster area.',
      href: '/areas/westminster-sc/land-clearing',
    },
  ];
  ...
  return (
    <>
      ...
      <main className="pt-16 lg:pt-[104px]">
          ...
          <div className="max-w-6xl mx-auto px-6">
            <Breadcrumbs
              items={[
                ...
                { label: 'Westminster, SC' },
              ]}
            />
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              STUMP GRINDING & LAND CLEARING IN WESTMINSTER, SC
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mb-8">
              Nelson Land & Stump provides professional stump grinding, brush hogging, and land clearing services
              throughout Westminster and Oconee County. From lakefront properties near Lake Hartwell to rural
              acreage near Chau Ram Falls, we&apos;ve got the equipment and experience to handle your project.
            </p>
        ...
        {/* About Westminster Service */}
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-black text-primary mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
                  YOUR LOCAL WESTMINSTER LAND CLEARING EXPERTS
                </h2>
                <p className="text-muted text-lg mb-4">
                  Westminster is a charming Oconee County town known for its proximity to Lake Hartwell and
                  the stunning Chau Ram Falls. Whether you&apos;re clearing land for a lakefront home, removing stumps
                  from your residential property, or preparing acreage for development, Nelson Land & Stump is here to help.
                </p>
                <p className="text-muted text-lg mb-4">
                  We understand the unique needs of Westminster property owners—from navigating lakefront lots
                  to clearing larger rural properties in Long Creek and Oakway. Our equipment is sized right
                  for any job, and we always leave your property clean and ready for the next step.
                </p>
              ...
              <div className="bg-muted-light rounded-lg p-8">
                <h3 className="font-bold text-primary text-xl mb-4">Why Westminster Chooses Us</h3>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <span className="text-muted"><strong>Lakefront Experience:</strong> We understand the unique needs of Lake Hartwell properties</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-accent mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-muted"><strong>Competitive Pricing:</strong> Fair rates for Westminster area projects</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-accent mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <p className="text-muted text-lg mb-8">
              We provide stump grinding, brush hogging, and land clearing services throughout Westminster and the surrounding areas, including:
            </p>
        ...
        <section className="py-16 bg-muted-light">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <p className="text-muted text-lg mb-8">
              In addition to Westminster, we provide services throughout Oconee County and Upstate South Carolina:
            </p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <Link href="/areas/fair-play-sc" className="bg-white p-4 rounded-lg text-center hover:shadow-md transition-shadow">
                <span className="font-bold text-primary">Fair Play</span>
              </Link>
        ...
        <section className="py-16 bg-primary">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl md:text-4xl font-black text-white mb-6" style={{ fontFamily: 'var(--font-oswald)' }}>
              NEED STUMP GRINDING IN WESTMINSTER?
            </h2>
            <p className="text-gray-300 text-lg mb-8">
              Contact Nelson Land & Stump today for a free, no-obligation quote on stump grinding,
              brush hogging, or land clearing services in Westminster, SC and surrounding areas.
            </p>
