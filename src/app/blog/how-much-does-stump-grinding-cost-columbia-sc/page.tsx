...
export const metadata: Metadata = {
  title: 'Stump Grinding Cost Columbia SC (2025) | Columbia Stump Grinding',
  description: 'Complete guide to stump grinding costs in Columbia and Midlands SC. Learn what affects pricing, average costs per stump, and how to get the best value. Free estimates available.',
  keywords: 'stump grinding cost Columbia SC, stump removal price, how much stump grinding, stump grinding rates Midlands SC, tree stump removal cost',
};
...
export default function StumpGrindingCostPost() {
  const articleSchema = {
    ...
    "@type": "Article",
    "headline": "How Much Does Stump Grinding Cost in Columbia SC? (2025 Prices)",
    "description": "Complete guide to stump grinding costs in Columbia and Midlands SC. Learn what affects pricing, average costs per stump, and how to get the best value.",
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.columbiastumpgrinding.com/blog/how-much-does-stump-grinding-cost-columbia-sc"
    }
  };
      ...
      <main className="pt-16 lg:pt-[104px]">
        ...
        <div className="relative h-64 md:h-96 w-full">
          <Image
            ...
            alt="Tree stump ready for grinding - stump grinding cost guide for Columbia SC"
            fill
          ...
          <div className="max-w-4xl mx-auto px-6">
            <div className="prose prose-lg max-w-none">
              <p className="text-xl text-muted leading-relaxed mb-8">
                ...
                straightforward breakdown of stump grinding prices in Columbia, Lexington, and the
                Midlands SC area.
              </p>

              <h2 className="text-2xl font-black text-primary mt-10 mb-4" style={{ fontFamily: 'var(--font-oswald)' }}>
                AVERAGE STUMP GRINDING COSTS IN MIDLANDS SC
              </h2>
              <p className="text-muted mb-6">
                For most residential stump grinding jobs in the Columbia area, you can expect to pay:
              </p>
              ...
              <div className="bg-accent/10 border-l-4 border-accent rounded-r-lg p-6 my-8">
                <h3 className="font-bold text-primary text-lg mb-2">Get a Free Quote from Columbia Stump Grinding</h3>
                <p className="text-muted mb-4">
                  We provide free, no-obligation estimates for stump grinding throughout Richland & Lexington Counties. Our quotes include everything—no hidden fees.
                </p>
                <Link
                  href="/#contact"
              ...
              <p className="text-muted mb-6">
                For most homeowners in Columbia and Midlands SC, expect to pay $100-$300 per stump for
